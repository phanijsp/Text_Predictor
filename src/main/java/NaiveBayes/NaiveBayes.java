...
public class NaiveBayes implements Serializable{
    ...
    private  ArrayList<ColumnItemObject> doom = new ArrayList<>();
    private  String[][] dataarr;
    private  String exstring="Given array length does not match with learned data";
    private  int predictarrlength;
...
/*
            for (NaiveBayes.ColumnItemObject columnItemObject : doom) {
...
*/
    ...
    private  ColumnItemObject getb(ArrayList<ColumnItemObject> cibs, String b){
    ...
    private  ArrayList<String> getoccurences(String[] arr){
...
//            }
    ...
    private  String[] getColumnArray(int column){
        String[] colArray=new String[dataarr.length];
        for(int row = 0; row < dataarr.length; row++) {
    ...
    private  ArrayList<String> setUniqueitems(String[] columnarray){
        ArrayList<String> uniqueitems = new ArrayList<>();
    ...
    private  String getLargest(ArrayList<ColumnItemObject> cio){
    ...
    private  class IncorrectLength extends Exception{
